...
int main(int argc, char *argv[]){
  ...
  if (argc != 6){
    printf("Usage: ./payloadBuilder payload.jpg EGG_TAG loaderstub.bin loader.bin boot.elf\n");
    printf("payload.jpg: The output file. Used by the flash exploit as the payload\n");
